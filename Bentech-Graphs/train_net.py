...
Comment added by MZA; usage: python train_net.py --dataset_name sample_1 --json_annotation_train train.json 
                             --image_path_train sample_1/ --json_annotation_val test.json --image_path_val sample_1/ 
                             --config-file fast_rcnn_R_50_FPN_3x.yaml --resume 
                             OUTPUT_DIR . SOLVER.IMS_PER_BATCH 2 SOLVER.MAX_ITER 1300 SOLVER.BASE_LR 0.00025
    1) Specifies model training for 13000 iterations and resumes training from last checkpoint. 
    2) Increase the SOLVER.MAX_ITER value to tra
