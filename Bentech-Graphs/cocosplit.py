...
"""
Usage: python cocosplit.py --annotation-path coco_dataset.json --train train.json --test test.json --split-ratio 0.85 --having-annotations
Comments: coco_dataset.json is the JSON file in COCO format for object detection in the input images. 
The outputs of this file are 2 files: train.json and test.json based on the split ratio provided.
"""
